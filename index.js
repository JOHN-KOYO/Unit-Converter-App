...
data[i].result.textContent = `${data[i].heading}\n${input1} ${data[i].firstUnit} = ${(input1 * data[i].convert1).toFixed(3)} ${data[i].secondUnit} | ${input1} ${data[i].secondUnit} = ${(input1 * data[i].convert2).toFixed(3)} ${data[i].firstUnit}`
    }
})
